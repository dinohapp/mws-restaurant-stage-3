...
self.addEventListener('install', function (event) {
	var cachedURLs = ['/', 'index.html', 'restaurant.html', 'css/styles.css', 'js/dbhelper.js', 'js/main.js', 'js/restaurant_info.js', 'img/1.jpg', 'img/2.jpg', 'img/3.jpg', 'img/4.jpg', 'img/5.jpg', 'img/6.jpg', 'img/7.jpg', 'img/8.jpg', 'img/9.jpg', 'img/10.jpg', 'img/undefined.jpg', 'img/icon-192.png', 'img/icon-512.png'
